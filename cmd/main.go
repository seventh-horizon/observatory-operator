...
import (
	...
	"github.com/seventh-horizon/observatory-operator/internal/controller"
...
func main() {
	...
	if err = (&controller.ObservatoryReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Observatory")
		os.Exit(1)
	}
